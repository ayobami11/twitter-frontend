...
const LikedTweet = ({ tweet, index }) => {
    ...
    const likeTweet = async (event) => {
        ...
        try {
            ...
            if (response?.data.success) {
                dispatch({ type: 'HANDLE_LIKE', payload: { index, tweetType: 'retweetedTweets' } });
            }
        } catch (error) {
            console.log(error);
        }
    ...
    const unlikeTweet = async (event) => {
        ...
        try {
            ...
            if (response?.data.success) {
                dispatch({ type: 'HANDLE_UNLIKE', payload: { index, tweetType: 'retweetedTweets' } })
            }
        } catch (error) {
            console.log(error);
        }
    ...
    const retweetTweet = async (event) => {
        ...
        try {
            ...
            if (response?.data.success) {
                dispatch({ type: 'HANDLE_RETWEET', payload: { index, tweetType: 'retweetedTweets' } })
            }
        } catch (error) {
            console.log(error);
        }
    ...
    const undoRetweet = async (event) => {
        ...
        try {
            ...
            if (response?.data.success) {
                dispatch({ type: 'HANDLE_UNDO_RETWEET', payload: { index, tweetType: 'retweetedTweets' } })
            }
        } catch (error) {
            console.log(error);
        }
